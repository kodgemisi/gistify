...
<div class="gistify-file">\
  <div class="gistify-file-header">\
    ...
    <ul class="gistify-button-group">\
      <li><a href="{{permalink}}" target="_blank" class="gistify-permalink" title="Permalink"><span class="mini-icon mini-icon-show mini-icon-link"></span></a></li>\
      <li><a href="{{rawUrl}}" target="_blank" class="gistify-raw-url" title="View Raw"><span class="mini-icon mini-icon-show mini-icon-code"></span></a></li>\
    </ul>\
  </div>\
...
<div class="gistify-file">\
  <div class="gistify-file-header-edit">\
    <span>\
      ...
      <button class="gistify-btn gistify-remove-btn"><span class="mini-icon mini-icon-show mini-icon-remove"></span></button>\
    </span>\
    <ul class="gistify-button-group">\
      <li><a href="{{permalink}}" target="_blank" class="gistify-permalink" title="Permalink"><span class="mini-icon mini-icon-show mini-icon-link"></span></a></li>\
      <li><a href="{{rawUrl}}" target="_blank" class="gistify-raw-url" title="View Raw"><span class="mini-icon mini-icon-show mini-icon-code"></span></a></li>\
...
<div class="gistify-footer">\
  ...
  <button class="gistify-token-btn gistify-btn">' + localize('Set Github token') + ' </button>\
  <a href="https://help.github.com/articles/creating-an-access-token-for-command-line-use/" target="_blank" title="Help about tokens" class="gistify-token-help gistify-btn"><span class="mini-icon mini-icon-show mini-icon-light-bulb"></span></a>\
...
Gist.prototype = {
  ...
  render: function () {
    ...
    if(this.config.description || !readonly){
      ...
      var processedTemplate = DESC_TEMPLATE
    ...
    if(this.config.mode == 'create') {
      ...
      for (var fileName in this.data.files) {
        if (this.data.files.hasOwnProperty(fileName)) {
          ...
          $fileDomElement.click(function (e) {
            editor.focus();
            e.stopPropagation();
          });
        }
  ...
  onSetToken: function (e) {
    ...
    gist.config.githubToken = newToken ? newToken : gist.config.githubToken;
